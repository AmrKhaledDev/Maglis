...
import EditPostBtn_Modal_Header from "./EditPostBtn_Modal_Header";
import EditPostBtn_Modal_Author from "./EditPostBtn_Modal_Author";
import EditPostBtn_Modal_Content from "./EditPostBtn_Modal_Content";
import EditPostBtn_Modal_Media from "./EditPostBtn_Modal_Media";
import EditPostBtn_Modal_Footer from "./EditPostBtn_Modal_Footer";
import { useToast } from "@/providers/ToastProvider";
import axios from "axios";
import { MediaType, Privacy } from "@prisma/client";
import { EditPostAction } from "@/actions/Post/Edit/EditPost.action";
// ==========================================================================================================
function EditPostBtn_Modal({
  post,
  setModal,
}: {
  post: PostDBType;
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/20 backdrop-blur z-60">
      ...
      >
        ...
        <EditPostBtn_Modal_Author
          post={post}
          setValue={setValue}
          privacy={privacy}
          loading={loading}
        />
        <EditPostBtn_Modal_Content content={content} register={register} />
        {fields && fields.length > 0 && (
          <EditPostBtn_Modal_Media loading={loading} fields={fields} remove={remove} />
        )}
        <EditPostBtn_Modal_Footer
          fields={fields}
          append={append}
          loading={loading}
        />
...
export default EditPostBtn_Modal;
